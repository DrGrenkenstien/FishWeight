...
data = pd.read_csv("https://raw.githubusercontent.com/DrGrenkenstien/FishWeight/master/Fish.csv")
#load label encoder
...
if st.button('Make Prediction'):
    ...
    st.write(f"If you loved it then follow me on [LinkedIn](https://www.linkedin.com/in/shubham-bhadoria-523864196/)")
